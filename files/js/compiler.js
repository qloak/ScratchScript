...
+
 function getParamsArray(params) {
     ...
     for (char of str) {
         ...
         if (char == '"') {
diff --git a/files/js/compiler.js b/files/js/compiler.js
index 9935da39d8d742d6e0798dd3a71a93a9ba46c97b..456dedaa91ba819a40059795ff813c0aabffe05d 100644
--- a/files/js/compiler.js
+++ b/files/js/compiler.js
